                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/shop/product-')}}{{$voiture->id}}.png" alt="product image">
                                            </figure>
                                            {{-- <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image">
                                            </figure>
                                        ...
                                        {{-- <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image"></div>
                                            <div><img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image"></div>
                                            <div><img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image"></div>
                                            <div><img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image"></div>
                                            <div><img src="{{asset('assets/imgs/shop/product-16.png')}}" alt="product image"></div>
                                    ...
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-linkedin"><a href="#"><img src="{{asset('assets/imgs/theme/icons/icon-penterest.svg')}}" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        @foreach($rvoitures as $rvoiture)
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('car.details',['slug'=>$rvoiture->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{asset('assets/imgs/shop/product-')}}{{$rvoiture->id}}.png" alt="{{$rvoiture->name}}">
                                                            <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$rvoiture->id}}.png" alt="{{$rvoiture->name}}">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('car.details',['slug'=>$rvoiture->slug])}}" tabindex="0">{{$rvoiture->name}}</a></h2>
                                                    <div class="rating-result" title="90%">
                                                        <span>
                                                        </span>
                                                    </div>
                                                    <div class="product-price">
                                                        <span>{{$rvoiture->regular_price}}</span>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <a href="{{route('car.details',['slug'=>$nvoiture->slug])}}">
                                        <img src="{{asset('assets/imgs/shop/product-')}}{{$nvoiture->id}}.png" alt="{{$nvoiture->name}}">
                                    </a>
                                </div>
